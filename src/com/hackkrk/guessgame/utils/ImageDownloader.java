...
public class ImageDownloader {
  ...
  public void download(String imageUrl, ImageView targetImageView) {

    resetPurgeTimer();
    Bitmap bitmap = getBitmapFromCache(imageUrl);

    if (bitmap == null) {
      if (cancelPotentialDownload(imageUrl, targetImageView)) {
      ...
      cancelPotentialDownload(imageUrl, targetImageView);
